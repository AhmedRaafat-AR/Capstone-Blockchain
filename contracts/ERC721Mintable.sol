...
//    @dev Approves another address to transfer the given token ID
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        // TODO return token approval if it
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(owner == from, "burn of token that is not own");
...
contract ERC721Mintable is ERC721Metadata {
    ...
    constructor(string memory name, string memory symbol) ERC721Metadata(
        name, symbol, "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") public {
