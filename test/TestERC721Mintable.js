...
contract('TestERC721Mintable', accounts => {
    ...
    const token_name = "Egypt";
    const token_symobl = "EG";
    let tokens = [2,4,6,8,10];
    

    describe('match erc721 spec', function () {
        beforeEach(async function () { 
            this.contract = await ERC721MintableComplete.new(token_name, token_symobl,{from: account_one});
        ...
        it('should transfer token from one owner to another', async function () {
            ...
            let new_owner = await this.contract.Owner.call({from: account_one});
